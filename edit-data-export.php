...
if($cek_jabatan == "admin" AND $identitas_jabatan == "admin"){
    $get_data = $_GET['data'];
    $check_data = mysqli_query($conn, "SELECT * FROM tb_export WHERE id_export = '$get_data'");
    ...
    if(mysqli_num_rows($check_data) == 0){
        ...
        $check_barang = mysqli_query($conn, "SELECT nama_barang, stok FROM tb_barang WHERE id_barang = '$id_barang'");
        ...
        if (isset($_POST['save'])) {
            ...
            $check_export = mysqli_query($conn, "SELECT * FROM tb_export WHERE id_export = '$get_data'");
            ...
            if(empty($post_quantity_before) || empty($post_quantity_after)) {
            ...
            } elseif ($data_barang['stok'] < $post_quantity_after OR $post_quantity_after > $data_barang['stok']) {
                $msg_type = "error";
                ...
                if($post_quantity_after > $post_quantity_before){
                    ...
                    $update = mysqli_query($conn, "UPDATE tb_export SET quantity = '$post_quantity_after' WHERE id_export = '$get_data'");
                } elseif($post_quantity_before > $post_quantity_after){
                    $update = mysqli_query($conn, "UPDATE tb_barang SET stok = stok+$count_quantity WHERE id_barang = '$id_barang'");
                    $update = mysqli_query($conn, "UPDATE tb_export SET quantity = '$post_quantity_after' WHERE id_export = '$get_data'");
                }
			...
			<div class="page-header float-right">
				<div class="page-title">
					<ol class="breadcrumb text-right">
                        ...
                        <li class="active">Edit Data Export</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php } ?>
                    <div class="card">
                        <div class="card-header">Edit Data Export</div>
                        <div class="card-body card-block">
                            <form method="post">
                                ...
                                <div class="form-actions form-group">
                                    <a href="<?php echo $base_link; ?>tampil-data-export.php" class="btn btn-danger btn-sm float-left">Batal</a>
