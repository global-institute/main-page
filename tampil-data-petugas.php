...
if($cek_jabatan == "admin" AND $identitas_jabatan == "admin" OR $cek_jabatan == "supervisor" AND $identitas_jabatan == "supervisor"){
    ...
    include 'header.php';
        ...
        if (isset($_POST['save'])) {
            $post_idpetugas = $_POST['idpetugas'];
            $post_nama = $_POST['nama'];
            $post_jk = $_POST['jk'];
            $post_telepon = $_POST['telepon'];
            $post_alamat = $_POST['alamat'];

            $check_petugas = mysqli_query($conn, "SELECT * FROM tb_petugas WHERE nama = '$post_nama' OR id_petugas = '$post_idpetugas'");
            $data_petugas = mysqli_fetch_assoc($check_petugas);

            if(empty($post_idpetugas) || empty($post_nama) || empty($post_jk) || empty($post_telepon) || empty($post_alamat)) {
                $msg_type = "error";
                ...
                $msg_type = "error";
                $msg_content = '<b>Gagal:</b> Data petugas sudah terdaftar sebelumnya.<script>swal("Gagal!", "Data petugas sudah terdaftar sebelumnya!", "error");</script>';
            } else {
                $insert = mysqli_query($conn, "INSERT INTO tb_petugas VALUES('$post_idpetugas','$post_nama','$post_jk','$post_telepon', '$post_alamat')");
                if($insert == TRUE){
                    $msg_type = "success";
        ...
        $getidpetugas = "PTG".$random_number."";
?>
                                    ...
                                    <div class="accordion-body">
                                        <form method="post">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-lg-10">
                                                    <p class="form-control-static">
                                                        <input type="text" id="text-input" name="idpetugas" placeholder="Masukkan id petugas" value="<?php echo $getidpetugas; ?>" class="form-control" autocomplete="off" readonly>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-lg-10">
                                                    <p class="form-control-static">
                                                        <input type="text" id="text-input" name="nama" placeholder="Masukkan nama lengkap" class="form-control" autocomplete="off" required>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-lg-10">
                                                    <p class="form-control-static">
                                                        <input type="number" id="text-input" name="telepon" placeholder="Masukkan nomor telepon" class="form-control" autocomplete="off" required>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                        $check_data_master = mysqli_query($conn, "SELECT * FROM tb_petugas ORDER BY nama");
                                        $no = 1;
                                        while($data_master = mysqli_fetch_assoc($check_data_master)) {
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $data_master['nama']; ?></td>
                                        <td><?php echo $data_master['jk']; ?></td>
                                        <td><?php echo $data_master['telepon']; ?></td>
                                        <td><?php echo $data_master['alamat']; ?></td>
                                        <td class="text-center"><a href="<?php echo $base_link; ?>edit-data-petugas.php?data=<?php echo $data_master['id_petugas']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a></td>
                                    </tr>
                                    <?php
                                        }
                                    ?>
